...
TOOL_CATEGORIES = {
    ...
    'project_complete': 'tools.project_complete',
    'timeline': 'tools.timeline',
    'timeline_advanced': 'tools.timeline_advanced',
    'timeline_advanced2': 'tools.timeline_advanced2',
    'timeline_complete': 'tools.timeline_complete',
    'timeline_operations': 'tools.timeline_operations',
    'timelineitem_advanced': 'tools.timelineitem_advanced',
    'timelineitem_advanced2': 'tools.timelineitem_advanced2',
    'timeline_item_complete': 'tools.timeline_item_complete',
    'media': 'tools.media',
    'mediapoolitem_advanced': 'tools.mediapoolitem_advanced',
    'mediapoolitem_complete': 'tools.mediapoolitem_complete',
    'mediapool_advanced': 'tools.mediapool_advanced',
    'mediapool_complete': 'tools.mediapool_complete',
    'mediapool_selection': 'tools.mediapool_selection',
    'folder_navigation': 'tools.folder_navigation',
    'color': 'tools.color',
    'colorgroup_operations': 'tools.colorgroup_operations',
    'colorgroup_complete': 'tools.colorgroup_complete',
    'delivery': 'tools.delivery',
    'render_settings': 'tools.render_settings',
    'render_advanced': 'tools.render_advanced',
    'resolve_complete': 'tools.resolve_complete',
    'fusion': 'tools.fusion',
    'fairlight': 'tools.fairlight',
    'media_storage': 'tools.media_storage',
    'gallery': 'tools.gallery',
    'gallery_advanced': 'tools.gallery_advanced',
    'gallerystillalbum_complete': 'tools.gallerystillalbum_complete',
    'cache': 'tools.cache',
    'phase6_final': 'tools.phase6_final',
    'graph': 'tools.graph',
    'advanced': 'tools.advanced',
    'complete_api_coverage': 'tools.complete_api_coverage',
}
